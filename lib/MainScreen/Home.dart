                ...
                ? ListView.builder(
                    ...
                    itemBuilder: ((context, index) {
                      ...
                      return GestureDetector(
                          ...
                          child: Bus_List[index]["Bus"] != null &&
                                  Bus_List[index]["Bus"]["latitude"] != null
                              ? Card(
                                  elevation: 20,
                                  child: ListTile(
                                    ...
                                    leading: Column(
                                      children: [
                                        ...
                                        Text(
                                          "Time : ${Bus_List[index]["Bus"]["Bus_Time"].toString()}",
                                          style: TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                                          ),
                                    ...
                                    title: Column(
                                      ...
                                      children: [
                                        Container(
                                            ...
                                            child: Text(
                                                "Bus No # : ${Bus_List[index]["Bus"]["Bus_Numb"]}",
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.bold,
                                                ))),
                                        Container(
                                            //  margin: EdgeInsets.all(5),
                                            child: Text(
                                                "Bus Route # :  ${Bus_List[index]["Bus"]["Bus_Route"].toString()}",
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.bold,
                                                ))),
